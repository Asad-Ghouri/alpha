...
function Mint() {
  ...
  const person = {
    ...
    occupation:
      "I'm Enrico, also known as Alpha, founder and CEO of Gianky Coin, a technological startup aiming to create innovative products for the financial, blockchain and internet service provision sectors in general. I started my business with Gianky Coin to provide innovative technological solutions that can contribute to the growth of the financial sector, knowledge of blockchain and DeFi (decentralized finance). We have developed an easy-to-use and accessible NFT platform, but also a BSC (binance smart chain) token that I hope will become a beneficial payment and investment tool for our supporters (holders), In addition, we are working on other blockchain-based products to help people understand, invest and benefit from the rapidly evolving technological environment. With the help of our team of experts. Our goal is to provide a superior quality service that allows everyone to use DeFi safely and conveniently. We hope that our platform will contribute to the spread of the blockchain & DeFi-based financial culture and to the growth of the global economy. Gianky Coin is a product created, managed, controlled and exclusively owned by the company Il Dattero based in Catania, Via Ferrante Aporti, 8 CAP 95123 Italy. P.I 05632770870; REA: CT-418000; tel.+39 095 8998538 website: www.ildattero.cloud",
  };
